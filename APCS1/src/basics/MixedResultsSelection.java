...
public class MixedResultsSelection {
	...
	public static void main(String[] args) {
		...
		case 1:
			MixedResults.testerFunction1();
			MixedResults.count++; // increase counter
			break;

		case 2:
			MixedResults.testerFunction2();
			MixedResults.count++;
			break;

		case 3:
			MixedResults.testerFunction3();
			MixedResults.count++;
			break;

		case 4:
			MixedResults.testerFunction4();
			MixedResults.count++;
			break;

		case 5:
			MixedResults.testerFunction5();
			MixedResults.count++;
			break;

		default:
			System.out.println("You Didn't Make a Selection!: "); // default action; loop back
