...
public class ShorthandMain {
	...
	public static void main(String[] args) {
		...
		do {
			...
			case "s1":
				string1.string1(); // s1, run string1
				break;

			case "s2":
				string2.string2(); // s2, run string2
				break;

			case "s3":
				string3.string3(); // s3, run string3
				break;

			case "s4":
				string4.string4(); // s4, run string4
				break;

			case "s5":
				string5.string5(); // s5, run string5
				break;
